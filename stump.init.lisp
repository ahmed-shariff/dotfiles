...
(defcommand gnew-train () ()
  ...
  (run-shell-command "xfce4-terminal --hide-menubar --initial-title 2 -x watch -n 1 nvidia-smi")
  (run-shell-command "xfce4-terminal --hide-menubar --initial-title 4 -x journalctl -f ")
  (run-shell-command "xfce4-terminal --hide-menubar --initial-title 3 -x watch -n 1 sensors")
